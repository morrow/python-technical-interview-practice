...
class BinaryTree(object):
    ...
    def search(self, query):
        ...
        False otherwise."""
        return self.preorder_search(tree.root, query)
    ...
    def preorder_search(self, current, query):
        if current:
            if current.value == query:
                return True
            else:
                return self.preorder_search(current.left, query) or self.preorder_search(current.right, query)
        return False
